...
<body>
	<form action="./signup" method="post">
		...
		-->
				...
				<div class="weui_cell">
					...
					<div class="weui_cell_bd weui_cell_primary">
						<input name="token" type="hidden" value="${token}"> <input
							name="name" class="weui_input" type="text" placeholder="请输入学生姓名">
					</div>
				</div>
				<!--
			<div class="weui_cell">
			...
			<!--按钮-->
			<div class="btn">
				<input type="submit" class="weui_btn weui_btn_primary" value="绑定" />
				<!--a href="./signup" class="weui_btn weui_btn_primary">绑定</a -->
				<!-- a href="./index" class="weui_btn weui_btn_default">取消</a -->
			</div>
		</div>
	</form>
</body>
